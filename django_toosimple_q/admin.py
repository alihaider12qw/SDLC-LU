...
class ParkingAreaResource(resources.ModelResource):
    class Meta:
        model = ParkingArea
        force_init_instance = True
        # fields = ["phone", "email", "address", "name", "case", "date",
        #           "custom_field_1", "custom_field_2", "custom_field_3"]
        # import_id_fields = ["phone", "email", "address", "name", "case",
        #                     "date", "custom_field_1", "custom_field_2", "custom_field_3"]


class ParkingAreaAdmin(ImportExportModelAdmin):
    list_display = (
        "id",
        "parking_area_name",
        "total_no_of_spots",
        "no_of_spots_occupied",
        "last_updated",
        "agent_id",
    )
    list_filter = (
    ...
    ordering = ["id"]
    resource_class = ParkingAreaResource
    force_init_instance = True
...
class AgentResource(resources.ModelResource):
    class Meta:
        model = Agent
        force_init_instance = True
        fields = ["venue_name", "floor_number"]


class AgentAdmin(ImportExportModelAdmin):
    list_display = ("id", "venue_name", "floor_number")
    list_filter = ("venue_name", "floor_number")
...
admin.site.site_header = "Parking Area Vehicle Detection System"
admin.site.index_title = "Parking Area Vehicle Detection System"
admin.site.site_title = "Parking Area Vehicle Detection System"
