...
class Agent(models.Model):
    ...
    id = models.BigAutoField(primary_key=True)
    venue_name = models.CharField(max_length=512, null=True, blank=False)
    ...
    def __str__(self):
        return f"{self.id}: {self.venue_name}"


class ParkingArea(models.Model):
    """Represents the Parking Areas"""

    id = models.BigAutoField(primary_key=True)
    parking_area_name = models.CharField(max_length=512, null=False, blank=False)
    total_no_of_spots = models.IntegerField(null=False, blank=False)
    no_of_spots_occupied = models.IntegerField(null=False, blank=False)
    ...
    def __str__(self):
        return f"ParkingArea id: {self.id}, name: {self.parking_area_name} for Agent: {self.agent_id}"
